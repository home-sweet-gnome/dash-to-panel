...
var dtpPanel = new Lang.Class({
	...
	//choose the leftBox or the centerBox to build taskbar
        ...
        this._MonitorsChangedListener = monitorManager.connect('monitors-changed', Lang.bind(this, function() {
            this._setPanelPosition();
    ...
    disable: function () {
        ...
        if(this._MonitorsChangedListener !== null) {
            global.display.disconnect(this._MonitorsChangedListener);
        }
    ...
    _dtpUpdateSolidStyle: function() {
        ...
        let activeWorkspace = global.workspace_manger.get_active_workspace();
