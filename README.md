...
Beyond that, just about every aspect of the panel is fully customizable using [Gnome Tweaks](https://gitlab.gnome.org/GNOME/gnome-tweaks) (`sudo apt install gnome-tweaks`) -> Extensions. From positioning and scaling panel elements to running indicators to multi-monitor display, to window previews and even intellihide, Dash to Panel has everything you need to make your workspace feel like home.
